...
CloudflareApps.siteId = "264c953fb2b1c5d6b85c3bf4947da7d4";
...
CloudflareApps.installs["LL5yj3RP1Cvz"] = {
    appId: "-gXRR7q4QzkP",
    scope: {}
};;
CloudflareApps.installs["LL5yj3RP1Cvz"].options = {
    "action": {
        "color": "#0073ce",
        "label": "Buy now",
        "newtab": true,
        "show": true,
        "url": "https://codecanyon.net/item/efood-food-delivery-system-with-laravel-admin-panel-delivery-man-app-v10/30320338?s_rank=1"
    },
    "delay": 1,
    "paused": true,
    "position": "left",
    "renew": "0sec",
    "text": {
        "html": "\u003cp\u003eBuy eFood single vendor license now and get 50% off.\u003c/p\u003e",
        "markdown": "Buy eFood single vendor license now and get 50% off."
    },
    "title": "50% Off !!!"
};;
CloudflareApps.installs["LL5yj3RP1Cvz"].URLPatterns = ["^6amtech.com/?.*$", "^demo.6amtech.com/?.*$", "^documentation.6amtech.com/?.*$", "^efood.6amtech.com/?.*$", "^emarket.6amtech.com/?.*$", "^grofresh.6amtech.com/?.*$", "^www.6amtech.com/?.*$"];;
(function() {
    try {
...
//     script.src = '/cdn-cgi/apps/body/pZ-uS8wkY6qLkg8GH4Nab1b4LyE.js';
