                                            ...
                                            @else
                                                <tr>
                                                    ...
                                                    <th width="25%">
                                                        ...
                                                        <select name="product_id[]" id="product_id" class="form-control products product_id select2" data-placeholder="- Select -" onchange="getProductVariations(this)" style="width: 100%" required>
                                                            <option></option>
                                                            {{-- @foreach ($products ?? [] as $product)
                                                                <option value="{{ $product->id }}"
                                                                    data-category="{{ optional($product->category)->name }}"
                                                    ...
                                                    <th width="10%">
                                                        <input type="text" name="sku[]" id="sku_id" class="form-control sku" readonly>
                                                    </th>
                                                    <th width="10%">
    ...
    function appendData(product, searchedValue, isReadonly){
        ...
        let tr = `<tr class="new-tr">
                ...
                <th width="10%">
                    ...
                    <input type="hidden" name="pdt_vat_amount[]" class="pdt-vat-amount">
                    <input type="hidden" name="pdt_vat_percent[]" class="pdt-vat-percent" value="${ product.vat }">
                    ...
                    <input type="hidden" name="pdt_discount_percent[]" class="form-control pdt-discount-percent text-right" value="${ product.current_discount != null ? product.current_discount.discount_percentage : 0 }" readonly>
