...
<body>
    @php
        ...
        $is_last = false;
    @endphp
    @foreach ($sale->saleDetails->chunk($chunk) as $key => $details)
                ...
                <div id="topPart">
                            ...
                            <div class="col-4" style="width: 33.33%">
                                <div class="print-copy-info">
                                    ...
                                    <div class="text-center">
                                        <img class="barcode-img pt-1" src="data:image/png;base64, {{ DNS1D::getBarcodePNG($sale->invoice_no , "C128") }}" alt="barcode" />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="">
                                        <div class="d-flex">
                                            ...
                                            <div class="info-side" style="margin-left: 30px;">
                                                <span style="display: block; text-align:left;"><b>{{ $sale->order_no }}</b></span>
                                                <span style="display: block; text-align:left;">{{ date('F d, Y', strtotime($sale->created_at)) }}</span>
                    ...
                    <div class="product-info">
                        <table>
                            ...
                            <tbody>
                                @php
                                    $skipCount = floor(count($sale->saleDetails) / $chunk);
                                    $skip = $skipCount ? count($sale->saleDetails) / $skipCount : $chunk;
                ...
                <div id="bottomPart">
                    <div class="row" style="display: {{ $loop_last && !$is_last ? 'flex' : 'none' }}; justify-content:space-between">
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4 order-note" style="width: 50%;">
                            <p>Quantity Total : <span></span></p>
                            <div class="balance-to-pay">
                                Balance to pay : {{ number_format($sale->payable_amount, 2, '.', '') }}
                            </div>
                        </div>
