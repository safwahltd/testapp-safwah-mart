        ...
        <div class="col-md-4">
            @if (optional($order->orderCustomerInfo)->ship_to_different_address == 'Yes')
                <table class="ml-5">
                    ...
                    <tr>
                        <td>Address</td>
                        <td>: {{ optional(optional($order->orderCustomerInfo)->receiverDistrict)->address }}</td>
                    </tr>
                    <tr>
                        <td>District</td>
                        ...
                        @foreach ($order->orderDetails as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    {{ optional($item->product)->sub_text != null ? '('.optional($item->product)->sub_text. ' ' . optional(optional($item->product)->unitMeasure)->name .')' : '' }}
                                </td>
                                <td class="text-right">{{ number_format($item->sale_price, 2, '.', '') }}</td>
                                <td class="text-center">{{ number_format($item->quantity, 2, '.', '') }}</td>
                                <td class="text-right">{{ round($item->total_amount) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <table class="pull-right" style="font-weight: bold">
                    ...
                    <tr>
                        <td>Shiping Cost</td>
                        <td class="pl-4">: {{ number_format($order->shipping_cost, 2, '.', '') }}</td>
                    </tr>
                    <tr>
                        <td>Discount</td>
                        <td class="pl-4">: {{ number_format($order->discount_amount, 2, '.', '') }}</td>
                    </tr>
                    <tr>
                        <td>Grand Total</td>
