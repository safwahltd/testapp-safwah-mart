...
@section('content')
    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <h4 class="pl-2"><i class="far fa-edit"></i> @yield('page-header')</h4>
        ...
        <div class="col-12">
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('inv.customers.update', $customer->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-lg-5" style="margin-left: 80px">
                                    ...
                                    <div class="input-group width-100">
                                        ...
                                        <select name="customer_type_id" id="customer_type_id" class="form-control select2" style="width: 100%">
                                            ...
                                            @foreach ($customerTypes as $customerType)
                                                <option value="{{ $customerType->id }}" {{ old('customer_type_id', $customer->customer_type_id) == $customerType->id ? 'selected' : '' }}>{{ $customerType->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="mobile" id="mobile" value="{{ old('mobile', $customer->mobile) }}" required>
                                    </div>
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="email" id="email" value="{{ old('email', $customer->email) }}">
                                    </div>
                                    ...
                                    <div class="input-group width-100">
                                        ...
                                        <select class="form-control select2" name="gender" id="gender" style="width: 100%">
                                            ...
                                            @foreach(['Male', 'Female', 'Others'] as $gender)
                                                <option value="{{ $gender }}" {{ old('gender', $customer->gender) == $gender ? 'selected' : '' }}>{{ $gender }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group mb-1">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-8 col-xs-8">
                                                <label style="margin-top: 7px">
                                                    <input name="status" class="ace ace-switch ace-switch-6" type="checkbox" @if($customer->status == 1 || old('status') == 'on') checked @endif>
                                                    <span class="lbl"></span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-8 col-xs-8">
                                                <label style="margin-top: 7px">
                                                    <input name="is_default" class="ace ace-switch ace-switch-6" type="checkbox" @if($customer->is_default == 1 || old('is_default') == 'on') checked @endif>
                                                    <span class="lbl"></span>
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-5" style="margin-left: 30px; margin-right: 60px">
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="zip_code" id="zip_code" value="{{ old('zip_code', $customer->zip_code) }}">
                                    </div>
