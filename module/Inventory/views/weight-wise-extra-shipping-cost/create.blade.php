...
@section('title', 'Create Weight Wise Extra Shipping Cost')
        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('inv.weight-wise-extra-shipping-costs.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="from_weight" value="{{ old('from_weight') }}" placeholder="From weight in kg" autocomplete="off" required>
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="to_weight" value="{{ old('to_weight') }}" placeholder="To weight in kg" autocomplete="off" required>
                                        <span class="input-group-addon">
                                            <i class="fas fa-balance-scale"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="extra_cost" value="{{ old('extra_cost') }}" placeholder="Extra Cost" autocomplete="off">
                                        <span class="input-group-addon">
                                            TK
                                        </span>
                                    </div>
