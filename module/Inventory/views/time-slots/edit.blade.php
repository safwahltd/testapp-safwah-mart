        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('inv.time-slots.update', $timeSlot->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 @error('name') has-error @enderror">
                                <input type="text" class="form-control" name="name" id="name" value="{{ old('name', $timeSlot->name) }}" placeholder="Slot Name" required>
                                @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 @error('starting_time') has-error @enderror">
                                <div class='input-group date' id='datetimepicker1'>
                                    <input type='text' name="starting_time" class="form-control" value="{{ old('starting_time', $timeSlot->starting_time) }}" autocomplete="off" placeholder="Starting Time"  style=" border-right: none;"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 @error('ending_time') has-error @enderror">
                                <div class='input-group date' id='datetimepicker2'>
                                    <input type='text' name="ending_time" class="form-control" value="{{ old('ending_time', $timeSlot->ending_time) }}" autocomplete="off" placeholder="Ending Time"  style=" border-right: none;"/>
                                    <span class="input-group-addon" style="padding: 6px 5px; background-color: transparent; ">
                                        <i class="far fa-clock"></i>
                                    </span>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 @error('disable_at') has-error @enderror">
                                <div class='input-group date' id='datetimepicker3'>
                                    <input type='text' name="disable_at" class="form-control" value="{{ old('disable_at', $timeSlot->disable_at) }}" autocomplete="off" placeholder="Disable At"  style=" border-right: none;"/>
                                    <span class="input-group-addon" style="padding: 6px 5px; background-color: transparent; ">
                                        <i class="far fa-clock"></i>
                                    </span>
                                </div>
                        ...
                        <div class="form-group" style="margin-top: -5px">
                            ...
                            <div class="col-sm-4 col-xs-8">
                                <label style="margin-top: 7px">
                                    <input name="status" class="ace ace-switch ace-switch-6" type="checkbox" @if(!empty($timeSlot->status)) checked @endif>
                                    <span class="lbl"></span>
                                </label>
                            </div>
                        </div>
