...
@section('title', 'Create Delivery Man')
        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('inv.delivery-mans.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-sm-4 @error('delivery_type') has-error @enderror">
                                <select class="form-control select2" name="delivery_type" id="delivery_type" data-placeholder="- Select -" style="width: 100%">
                                    ...
                                    @foreach($deliveryTypes ?? [] as $type)
                                        <option value="{{ $type }}" {{ old('delivery_type') == $type ? 'selected' : '' }}>{{ $type }}</option>
                                    @endforeach
                                </select>
                                @error('delivery_type')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 @error('district_id') has-error @enderror">
                                <select name="district_id" id="district_id" onchange="getAreas(this)" class="form-control select2" data-placeholder="--- Select District ---" style="width: 100%">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 @error('area_id') has-error @enderror">
                                <select name="area_id" id="area_id" class="form-control select2" data-placeholder="--- Select a District First ---" style="width: 100%">
                                    <option></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 @error('name') has-error @enderror">
                                <input type="text" class="form-control" name="name" id="name"
                                       value="{{ old('name') }}" placeholder="Delivery Man Name" required>
                                @error('name')
                                <span class="text-danger">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 @error('address') has-error @enderror">
                                <textarea name="address" id="address" rows="3" class="form-control" placeholder="Address here ...">{{ old('address') }}</textarea>
                                @error('address')
                                <span class="text-danger">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="form-field-1-1"> Password </label>
                            <div class="col-sm-4 @error('address') has-error @enderror">
