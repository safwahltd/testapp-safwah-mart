        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('inv.shipping-cost-discounts.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="from_amount" value="{{ old('from_amount') }}" placeholder="From Amount" autocomplete="off" required>
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="to_amount" value="{{ old('to_amount') }}" placeholder="To Amount" autocomplete="off" required>
                                        <span class="input-group-addon">
                                            TK
                                        </span>
                                    </div>
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="discount" value="{{ old('discount') }}" placeholder="Discount" autocomplete="off">
                                        <span class="input-group-addon">
                                            TK
                                        </span>
                                    </div>
