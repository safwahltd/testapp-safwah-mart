        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('inv.coupons.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <select name="use_type" id="use_type" class="form-control select2"
                                            ...
                                            <option value="Once" {{ old('use_type') == 'Once' ? 'selected' : '' }}>Once
                                            </option>
                                            <option value="Multiple" {{ old('use_type') == 'Multiple' ? 'selected' : '' }}>
                                                Multiple</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name"
                                            value="{{ old('name') }}" placeholder="Coupon Name" autocomplete="off"
                                            required>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="code" id="coupon"
                                            value="{{ old('code') }}" placeholder="Coupon Code" autocomplete="off"
                                            required>
                                    </div>
                                    @error('code')
                                        <span class="text-danger">
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control date-picker" name="start_date"
                                            value="{{ old('start_date') }}" placeholder="Start Date" autocomplete="off"
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control date-picker" name="end_date"
                                            value="{{ old('end_date') }}" placeholder="End Date" autocomplete="off"
                                            data-date-format="yyyy-mm-dd" required>
                                    </div>
                                    ...
                                    <div class="input-group width-100">
                                        ...
                                        <select name="discount_type" id="discount_type" class="form-control select2"
                                            ...
                                            <option value="Percent"
                                                {{ old('discount_type') == 'Percent' ? 'selected' : '' }}>Percent</option>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="amount"
                                            value="{{ old('amount') }}" placeholder="Amount" autocomplete="off"
                                            required>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="max_price_discount"
                                            value="{{ old('max_price_discount') }}" placeholder="100"
                                            autocomplete="off">
                                    </div>
