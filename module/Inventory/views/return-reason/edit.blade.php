...
@section('title', 'Edit Return Reason')
        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('inv.return-reasons.update', $returnReason->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="title" value="{{ old('title', $returnReason->title) }}" placeholder="Title" autocomplete="off" required>
                                    </div>
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <textarea class="form-control" name="description" cols="30" rows="3" placeholder="Description">{{ old('description', $returnReason->description) }}</textarea>
                                    </div>
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="number" class="form-control" name="serial_no" value="{{ old('serial_no', $returnReason->serial_no) }}" placeholder="Serial No" autocomplete="off" required>
                                    </div>
                                ...
                                <div class="form-group" style="margin-top: -5px">
                                    ...
                                    <div class="col-sm-4 col-xs-8">
                                        <div class="material-switch pt-1 pl-3">
                                            <input type="checkbox" name="status" id="status" @if($returnReason->status == 1 || old('status') == 'yes') checked @endif />
