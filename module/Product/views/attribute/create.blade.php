...
@section('title', 'Crearte Attribute')
        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('pdt.attributes.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <div class="input-group width-100">
                                        ...
                                        <select name="attribute_type_id" id="attribute_type_id" class="form-control select2" data-placeholder="--- Select ---" style="width: 100%">
                                            ...
                                            @foreach($attributeTypes as $id => $value)
                                                <option value="{{ $id }}" {{ old('attribute_type_id') == $id ? 'selected':'' }}>{{ $value}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control colorpicker-element" name="color_code" id="colorpicker1" value="{{ old('color_code') }}" placeholder="#ffffff" autocomplete="off">
                                    </div>
