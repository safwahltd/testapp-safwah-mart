        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('pdt.writers.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        value="{{ old('name') }}" placeholder="Writer Name" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group width-100">
                                            ...
                                            value="{{ old('slug') }}" placeholder="Writer Slug" required>
                                            </div>
                                        @error('slug')
                                            <span class="text-danger">
                                                {{ $message }}
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input name="title" id="title" class="form-control" placeholder="Writer title" value="{{ old('title') }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input name="phone" id="phone" class="form-control" placeholder="Writer phone" value="{{ old('phone') }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input name="email" id="email" class="form-control" placeholder="Writer email" value="{{ old('email') }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input name="address" id="address" class="form-control" placeholder="Writer address" value="{{ old('address') }}">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <textarea name="description" id="description" class="form-control" placeholder="Writer description">{{ old('description') }}</textarea>
                                    </div>
