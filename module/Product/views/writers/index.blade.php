...
@section('content')
    <div class="page-header">
        ...
        <div class="btn-group">
            <a class="btn btn-sm btn-primary" href="{{ route('pdt.writers.create') }}">
    ...
    <form action="{{ route('pdt.writers.index') }}" method="GET">
        <div class="row">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="table-responsive">
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li>
                                                <a href="{{ route('pdt.writers.edit', $item->id) }}" title="Edit">
                                                    <i class="fa fa-pencil-square-o"></i> Edit
                                                </a>
                                            </li>

                                            {{-- DELETE START --}}
                                            @php $countWriterInBook = \Module\Product\Models\BookProduct::where('writer_id', $item->id)->count(); @endphp
                                            <li>
                                                @if($countWriterInBook < 1)
                                                    <a href="javascript:void(0)" title="Delete" onclick="delete_item('{{ route('pdt.writers.destroy', $item->id) }}')" type="button">
                ...
                @include('partials._paginate',['data'=> $writers])
            </div>
        </div>
    </div>
@endsection
...
@section('script')
    ...
    <script>
        function cantDeleteAlert() {
            Swal.fire('<p style="font-size:15px;">You can\'t delete this Writer. Because there are one or more Writer has in this Book.</p>')
        }
    </script>
