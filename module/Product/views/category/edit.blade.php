        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('pdt.categories.update', $category['id']) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3 col-xs-8">
                                                <label>
                                                    <input name="show_on_menu" class="ace ace-switch ace-switch-6" type="checkbox"  @if($category->show_on_menu == 'Yes') checked @endif>
                                                    <span class="lbl"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3 col-xs-8">
                                                <label>
                                                    <input name="is_highlight" class="ace ace-switch ace-switch-6" type="checkbox"  @if($category->is_highlight == 'Yes') checked @endif>
                                                    <span class="lbl"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3 col-xs-8">
                                                <label>
                                                    <input name="status" class="ace ace-switch ace-switch-6" type="checkbox" @if(!empty($category->status)) checked @endif>
                                                    <span class="lbl"></span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <select name="parent_id" id="parent_id" class="form-control select2" style="width: 100%" onchange="getProductType(this)">
                                            ...
                                            @foreach ($categories ?? [] as $parentCategory)
                                                ...
                                                <option value="{{ $parentCategory->id }}"
                                                    ...
                                                    {{ $parentCategory->id == $category->id ? 'disabled' : '' }}
                                                ...
                                                @foreach ($parentCategory->childCategories ?? [] as $childCategory)
                                                    ...
                                                    @include('category._inc._include-options-edit', ['childCategory' => $childCategory, 'space' => 1])
                                                @endforeach
                                ...
                                <!-- PRODUCT TYPE -->
                                <div class="form-group mb-1" id="productType" style="{{ $category->parent_id != null ? 'display: none' : '' }}">
                                    <div class="input-group width-100">
                                        <span class="input-group-addon width-30" style="text-align: left">Product Type <sup class="text-danger">*</sup></span>
                                        <select name="product_type_id" id="product_type_id" class="form-control select2" style="width: 100%" required>
                                            @foreach($productTypes as $productType)
                                                <option value="{{ $productType->id }}" {{ old('product_type_id', $productType->id == $category->product_type_id ? 'selected':'') }}>{{ $productType->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        value="{{ old('title', $category->title) }}" placeholder="Category Title">
                                   </div>
                                    @error('title')
                                        <span class="text-danger">
                                            {{ $message }}
                                ...
                                @if (hasAnyPermission(['website-cms.meta-tag'], $slugs))
                                    ...
                                    <div class="form-group">
                                        <div class="input-group width-100">
                                            ...
                                            <input type="text" class="form-control" name="meta_title" value="{{ old('meta_title', $category->meta_title) }}" placeholder="Meta Title Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group width-100">
                                            ...
                                            <textarea style="min-height: 70px" class="form-control" placeholder="Type Meta Description" name="meta_description">{{ old('meta_description', $category->meta_description) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group width-100">
                                            ...
                                            <input type="text" class="form-control" name="alt_text" value="{{ old('alt_text', $category->alt_text) }}" placeholder="Meta Alt Text">
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="file" class="form-control" name="image" @if(empty($category->image)) @endif>
                                    </div>
                                    <div class="input-group width-100">
                                    ...
                                    <img class="pt-1" src="{{ file_exists($category->image) ? asset($category->image) : asset('default.svg') }}" width="100">
                                ...
                                <div class="form-group mb-1">
                                    ...
                                    <img class="pt-1" src="{{ file_exists($category->icon) ? asset($category->icon) : asset('default.svg') }}" width="100">
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="file" class="form-control" name="banner_image" @if(empty($category->banner_image)) @endif>
                                    </div>
                                    <div class="input-group width-100">
                                        <span class="input-group-addon width-30" style="background-color: transparent !important; border:none !important;"></span>
                                    ...
                                    <img class="pt-1" src="{{ file_exists($category->banner_image) ? asset($category->banner_image) : asset('default.svg') }}" width="100">
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="number" class="form-control" name="serial_no" id="serial_no" value="{{ old('serial_no', $category->serial_no) }}" placeholder="Serial No">
                                        </div>
