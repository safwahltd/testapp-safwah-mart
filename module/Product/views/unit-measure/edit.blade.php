        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('pdt.unit-measures.update', $unitMeasure->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <textarea class="form-control" name="description" id="description" rows="3">{{ old('description', $unitMeasure->description) }}</textarea>                                    </div>
