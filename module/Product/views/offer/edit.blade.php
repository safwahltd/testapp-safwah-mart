        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('pdt.offers.update', $offer->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <div class="form-group mb-1">
                                    @if(file_exists($offer->banner_image))
                                        <div class="mb-1">
                                            <img src="{{ asset($offer->banner_image) }}" width="100%" height="100px" alt="Banner Image">
                                        </div>
                                    @endif

                                    <div class="input-group width-100">
                                        <span class="input-group-addon width-30" style="text-align: left">Offer Name <sup class="text-danger">*</sup></span>
                                        <input type="text" class="form-control" name="name" id="name" value="{{ old('name', $offer->name) }}" placeholder="Offer Name" autocomplete="off" required>
                                    </div>
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="slug" id="slug" value="{{ old('slug', $offer->slug) }}" placeholder="Offer Slug" autocomplete="off" required>
                                    </div>
                                ...
                                <div class="form-group mb-1">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="number" class="form-control" name="serial_no" value="{{ old('serial_no', $offer->serial_no) }}" placeholder="Serial No" autocomplete="off" required>
                                    </div>
                                ...
                                <div class="form-group" style="margin-top: -5px">
                                    ...
                                    <div class="col-sm-4 col-xs-8">
                                        <div class="material-switch pt-1 pl-3">
                                            <input type="checkbox" name="status" id="status" @if($offer->status == 1 || old('status') == 'yes') checked @endif />
