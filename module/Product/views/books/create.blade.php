        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('pdt.books.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <div class="input-group width-100">
                                        ...
                                        <select name="product_type_id" id="product_type_id" class="form-control select2" data-placeholder="--- Select ---" style="width: 100%">
                                            ...
                                            @foreach($productTypes as $productType)
                                                <option value="{{ $productType->id }}" {{ old('product_type_id') }}>{{ $productType->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        value="{{ old('title') }}" placeholder="Category Title">                                    </div>
