    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <h4 class="pl-2"><i class="fa fa-plus"></i> Add New Brand</h4>
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('pdt.brands.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" value="{{ old('name') }}" placeholder="Brand Name" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group width-100">
                                            ...
                                            <input type="text" class="form-control" name="slug" id="slug" value="{{ old('slug') }}" placeholder="Category Slug" required>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title" value="{{ old('title') }}" placeholder="Category Title">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        <span class="input-group-addon width-30" style="text-align: left">Position <sup class="text-danger"></sup></span>
                                ...
                                <div class="btn-group pull-right">
                                    <a href="{{ route('pdt.brands.index') }}" class="btn btn-sm btn-secondary"> <i class="fa fa-list"></i> List </a>
