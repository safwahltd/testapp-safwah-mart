        ...
        <div class="col-12">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('pdt.product-tags.update', $productTag->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        value="{{ old('name', $productTag->name) }}" placeholder="Product Tag Name" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       value="{{ old('slug', $productTag->slug) }}" placeholder="Product Tag Slug" required>
                                            </div>
                                        @error('slug')
                                            <span class="text-danger">
                                                {{ $message }}
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3 col-xs-8">
                                                <label>
                                                    <input name="status" class="ace ace-switch ace-switch-6" type="checkbox" @if(!empty($productTag->status)) checked @endif>
                                                    <span class="lbl"></span>
                                                </label>
                                            </div>
                                        </div>
