...
@section('title', 'Products Variations')

@section('page-header')
    <i class="fa fa-info-circle"></i> Products Variations
@stop
            ...
            <div class="widget-box">
                ...
                <div class="widget-header">
                    ...
                    <span class="widget-toolbar">
                        ...
                        <a href="{{ route('pdt.products.create', ['upload-variation' => 'product']) }}" class="">
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($products as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>{{ optional($item->productUpload)->name }}</td>
                                                    <td>{{ $item->name }}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group btn-corner">
                                                            ...
                                                            <!-- edit -->
                                                            <a href="{{ route('pdt.product-variation-uploads.edit', $item->id) }}"
                                                            ...
                                                            <!-- delete -->
                                                            <button type="button"
                                                                onclick="delete_item(`{{ route('pdt.product-variation-uploads.destroy', $item->id) }}`)"
