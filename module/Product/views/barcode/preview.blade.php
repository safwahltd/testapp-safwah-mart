    ...
    @foreach($product_details as $details)
        @while($details['qty'] > 0)
            ...
            <div style="display:inline-block;vertical-align:middle;line-height:13px !important;">
                ...
                @endif
                {{-- Barcode --}}
                <img class="center-block" style="max-width:90%; !important;height: {{$barcode_details->height*0.30}}in !important;" src="data:image/png;base64,{{DNS1D::getBarcodePNG($details['details']->sub_sku, $details['details']->barcode_type, 3,70,array(39, 48, 54), false)}}">
                {{-- Price --}}
                @if(!empty($print['price']))
                    <p style="margin: 2px">{{$details['details']->sub_sku}}
