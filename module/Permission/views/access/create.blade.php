        ...
        <div class="col-sm-12">
            <div class="widget-box">
                <div class="widget-header" style="background:#DFE2CD">
                    ...
                    <h4 class="widget-title" style="font-size:20px !important; color:#41B883"> 
                    ...
                    <div class="widget-main">
                        <form class="form-horizontal" action="{{ route('permission-access.store') }}" method="POST"
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-4" style="height: 40px;">
                                   <div class="input-group" style="width:100%">
                                       ...
                                       <select class="chosen-select-280 form-control" id="select-new-employee-id" onchange="loadEmployeeInfo(this)" name="user_id" required>
                            ...
                            {{-- @if (in_array('Company', $hasFeatures))
                                <div class="panel-group" style="margin-top:40px" id="accordion" role="tablist"
                                        ...
                                        <div class="panel-heading" role="tab" id="company_collapse">
                                            <h4 class="panel-title">
                                                <a role="button" data-toggle="collapse" data-parent="#accordion"
                                                    href="#collapse_company" aria-expanded="true"
                                                    aria-controls="collapse_company">
                                                    <i class="short-full glyphicon glyphicon-plus"></i>
                                                    <span
                                                        style="line-height:12px; font-size:15px; font-weight:800; letter-spacing: 1.5px">
                                                        Companies </span>
                                                </a>
                                            </h4>
                                        </div>

                                        <div id="collapse_company" class="panel-collapse collapse" role="tabpanel"
                                            aria-labelledby="company_collapse">
                                                            ...
                                                            <tr>
                                                                <td colspan="5">
                                                                    <label>
                                                                        ...
                                                                        <span class="lbl"
                                                                            style="font-weight:800"> Select All </span>
                                                                    </label>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                                            ...
                                                                            <label>
                                                                                @if (isset($hasCompanies))
                                                                                    <input name="companies[]"
                                                                                        value="{{ $id }}"
                                                                                        {{ in_array($company, $hasCompanies) ? 'checked' : '' }}
                                                                                        type="checkbox"
                                                                                        class="ace childCheckBox">
                                                                                @else
                                                                                    <input name="companies[]"
                                                                                        value="{{ $id }}"
                                                                                        type="checkbox"
                            ...
                            <!-- Department -->
                            {{-- @if (in_array('Department', $hasFeatures) && class_exists('Module\HRM\Models\Department'))
                                <div class="panel-group" style="margin-top:40px" id="accordion" role="tablist"
                                    aria-multiselectable="true">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="department_collapse">
                                            <h4 class="panel-title">
                                                <a role="button" data-toggle="collapse" data-parent="#accordion"
                                                    href="#collapse_department" aria-expanded="true"
                                        ...
                                        <div id="collapse_department" class="panel-collapse collapse" role="tabpanel"
                                            aria-labelledby="department_collapse">
                                            <div class="panel-body">
                                                <div class="row order-type">
                                                    <table class="table table-bordered table-sm mx-auto"
                                                        style="width:98%; margin-left:auto; margin-right:auto; color:#41B883">
                                                                            ...
                                                                            <label>
                                                                                @if (isset($hasDepartments))
                                                                                    <input name="departments[]"
                                                                                        value="{{ $id }}"
                                                                                        {{ in_array($department, $hasDepartments) ? 'checked' : '' }}
                                                                                        type="checkbox"
                                                                                        class="ace childCheckBox">
                                                                                @else
                                                                                    <input name="departments[]"
                            ...
                            <!-- Designation -->
                            {{-- @if (in_array('Designation', $hasFeatures) && class_exists('Module\HRM\Models\Designation'))
                                <div class="panel-group" style="margin-top:40px" id="accordion" role="tablist"
                                    aria-multiselectable="true">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="designation_collapse">
                                            <h4 class="panel-title">
                                                <a role="button" data-toggle="collapse" data-parent="#accordion"
                                                    href="#collapse_designation" aria-expanded="true"
                                        ...
                                        <div id="collapse_designation" class="panel-collapse collapse" role="tabpanel"
                                            aria-labelledby="designation_collapse">
                                            <div class="panel-body">
                                                <div class="row order-type">
                                                    <table class="table table-bordered table-sm mx-auto"
                                                        style="width:98%; margin-left:auto; margin-right:auto; color:#41B883">
                                                                            ...
                                                                            <label>
                                                                                @if (isset($hasDepartments))
                                                                                    <input name="designations[]"
                                                                                        value="{{ $id }}"
                                                                                        {{ in_array($designation, $hasDesignations) ? 'checked' : '' }}
                                                                                        type="checkbox"
                                                                                        class="ace childCheckBox">
                                                                                @else
                                                                                    <input name="designations[]"
                            ...
                            <!-- Factory -->
                            {{-- @if (in_array('Factories', $hasFeatures))
                                <div class="panel-group" style="margin-top:40px" id="accordion" role="tablist"
                                    aria-multiselectable="true">

                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="factory_collapse">
                                            <h4 class="panel-title">
                                                <a role="button" data-toggle="collapse" data-parent="#accordion"
                                                    href="#collapse_factories" aria-expanded="true"
                                                    aria-controls="collapse_factories">
                                                    <i class="short-full glyphicon glyphicon-plus"></i>
                                                    <span
                                                        style="line-height:12px; font-size:15px; font-weight:800; letter-spacing: 1.5px">
                                                        Factories </span>
                                        ...
                                        <div id="collapse_factories" class="panel-collapse collapse" role="tabpanel"
                                            aria-labelledby="factory_collapse">
                                            <div class="panel-body">
                                                <div class="row order-type">
                                                    <table class="table table-bordered table-sm mx-auto"
                                                        style="width:98%; margin-left:auto; margin-right:auto; color:#41B883">
                                                        ...
                                                        <tbody>
                                                            @foreach ($factories->chunk(5) as $row)
                                                                <tr>
                                                                    @foreach ($row as $id => $factory)
                                                                        <td width="20%">
                                                                            <label>
                                                                                @if (isset($hasFactories))
                                                                                    <input name="factories[]"
                                                                                        value="{{ $id }}"
                                                                                        {{ in_array($factory, $hasFactories) ? 'checked' : '' }}
                                                                                        type="checkbox"
                                                                                        class="ace childCheckBox">
                                                                                @else
                                                                                    <input name="factories[]"
                            ...
                            @if ($modules->count() > 0)
                                <div class="well text-center"
                                    style="margin-top:30px; margin-left:auto; margin-right:auto; font-size:20px; padding:10px; font-weight:bold">
                                    Access Control</div>
                            @endif
