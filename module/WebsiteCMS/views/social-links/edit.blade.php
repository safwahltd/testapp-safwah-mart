...
@section('page-header')
    <i class="fa fa-plus-circle"></i> <span class="hide-in-sm">Edit</span> Social Link
@stop
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form method="POST" action="{{ route('website.social-links.update', $social_link->id) }}" class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control name" type="text" name="name" autocomplete="off"
                                        value="{{ old('name',$social_link->name) }}" placeholder="Name" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control slug" id="url" type="text" name="url" autocomplete="off"
                                        value="{{ old('url',$social_link->url) }}" placeholder="Url" required />
                                </div>
                            </div>
