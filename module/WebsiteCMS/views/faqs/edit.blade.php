...
@section('page-header')
    <i class="fa fa-edit"></i> <span class="hide-in-sm">Edit</span> Faq
@stop
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form method="POST" action="{{ route('website.faqs.update', $faq->id) }}" class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control name" type="text" name="title" autocomplete="off"
                                        value="{{ old('title', $faq->title) }}" placeholder="Title" required />
                                </div>
                            </div>
