...
@section('page-header')
    <i class="fa fa-plus"></i> Edit Page Section
    ...
    <div class="page-content no-print">
        <div class="row">
            ...
            <div class="widget-box">
                ...
                <form action="{{ route('website.page-sections.update',$PageSection->id) }}" id="Form" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-sm-12 px-3">
                                        ...
                                        <div class="input-group width-100 mb-1">
                                            ...
                                            <input type="text" class="form-control @error('title') has-error @enderror" name="title" value="{{ $PageSection->title }}">
                                            @error('title')<br>
                                        ...
                                        <div class="input-group width-100 mb-1">
                                            ...
                                            <textarea class="form-control" name="short_description" id="short_description" cols="30" rows="2" placeholder="Short Description" required>{{ old('short_description', $PageSection->short_description) }}</textarea>
                                        ...
                                        <div class="input-group width-100 mb-1">
                                            ...
                                            <img class="pt-1" src="{{ asset($PageSection->background_image) }}" width="100" style="margin-left: 13px;">
                                        </div>
                            ...
                            <div class="col-xs-5">
                                <div class="row" style="margin:0px">
                                        ...
                                        <div class="input-group width-100 mb-1">
                                            ...
                                            <input type="text" class="form-control @error('show_quantity') has-error @enderror" name="show_quantity" id="show_quantity" value="{{ $PageSection->show_quantity }}">
                                        ...
                                        <div class="input-group width-100 mb-1">
                                            ...
                                            <input type="text" class="form-control @error('button_name') has-error @enderror" name="button_name" id="name" value="{{ $PageSection->button_name }}">
                                            @error('title')<br>
                                                <span class="text-danger">
                                                    {{ $message }}
                                                </span>
                                        ...
                                        <div class="input-group width-100 mb-1">
                                            ...
                                            <input type="text" class="form-control @error('button_slug') has-error @enderror" name="button_slug" id="slug" value="{{ $PageSection->button_slug }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3 col-xs-8">
                                                <label>
                                                    <input name="button_status" class="ace ace-switch ace-switch-6" type="checkbox" {{ $PageSection->button_status == 1 ? 'checked' : '' }}>
                                                    <span class="lbl"></span>
                                                </label>
                                            </div>
                                        </div>
