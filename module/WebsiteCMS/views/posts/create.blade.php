            ...
            <div class="widget-box">
                <div class="widget-header">
                    <h5 class="widget-title">
                        <i class="ace-icon fa fa-plus-circle"></i>Add New Post
                    </h5>
                ...
                <form action="{{ route('website.posts.store') }}" id="Form" method="post" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="col-sm-12 px-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="short_desc"
                                                class="form-control input-sm">{{ old('short_desc') }}</textarea>
                                            <div class="space-10"></div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="seo_title"
                                                class="form-control input-sm">{{ old('seo_title') }}</textarea>
                                            <div class="space-10"></div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="seo_description"
                                                class="form-control input-sm">{{ old('seo_description') }}</textarea>
                                            <div class="space-10"></div>
                                        </div>
                                ...
                                <div class="row" style="margin:15px">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="format_type" class="form-control chosen-selecst select2"
                                            data-placeholder="--Select Format--">
                                            <option value=""></option>
