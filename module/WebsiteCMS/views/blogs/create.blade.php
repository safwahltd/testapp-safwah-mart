        ...
        <div class="col-12">
                ...
                <ul class="breadcrumb mb-1">
                    ...
                    <li>
                        @if(hasPermission("website-cms.index", $slugs))
                            <a class="text-muted" href="{{ route('website.blogs.index') }}">Article</a>
                        @endif
                    </li>
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form class="form-horizontal mt-2" action="{{ route('website.blogs.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" value="{{ old('name') }}" placeholder="Article Name" required>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group width-100">
                                        ...
                                        <input type="text" class="form-control" name="slug" id="slug" value="{{ old('slug') }}" placeholder="Article Slug" required>
                                    </div>
                                    @error('slug')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <div>
                                        <textarea name="description" id="description" class="summernote form-control" placeholder="Article description">{{ old('description') }}</textarea>
                                   </div>
