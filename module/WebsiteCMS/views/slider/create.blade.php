                                ...
                                <div class="row">
                                    <div class="col-sm-12 px-3">
                                        ...
                                        <div class="input-group width-100 mb-1">
                                            ...
                                            <input type="text" class="form-control @error('title') has-error @enderror" name="name" id="name" value="">
                                            @error('title')<br>
                                          ...
                                          <div class="input-group width-100 mb-1">
                                            ...
                                            <input type="text" class="form-control @error('slug') has-error @enderror" name="slug" id="slug" value="" required>
                                            @error('slug')<br>
                                                <span class="text-danger">
                                                    {{ $message }}
                                                </span>
                            ...
                            <div class="col-xs-5">
                                <div class="row" style="margin:0px">
                                    ...
                                    <div class="input-group width-100 mb-1">
                                        ...
                                        <input type="text" class="form-control @error('button_title') has-error @enderror" name="button_title" id="button_title" value="">
                                        @error('title')<br>
                                            <span class="text-danger">
                                                {{ $message }}
                                            </span>
                                    ...
                                    <div class="input-group width-100 mb-1">
                                        ...
                                        <input type="text" class="form-control @error('button_url') has-error @enderror" name="button_url" id="button_url" value="">
                                        @error('title')<br>
                                            <span class="text-danger">
                                                {{ $message }}
                                            </span>
