...
@section('page-header')
    <i class="fa fa-plus-circle"></i> <span class="hide-in-sm">Add</span> Menu
@stop
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form method="POST" action="{{ route('website.widget-menus.store') }}" class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <select name="menu_category_id" class="form-control select2"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <input class="form-control" type="number" name="order_no" autocomplete="off"
                                        value="{{ old('order_no') }}" placeholder="Order No." required />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 text-center" style="width: 100%">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-save"></i> Add Menu Category
                                    </button>
                                </div>
                            </div>
                        </form>
