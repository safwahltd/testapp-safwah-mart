...
@section('title', 'View Order By Picture')
@section('css')
    <style>
        .modal-target {
            width: 300px;
        ...
        <div class="col-12">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                ...
                <ul class="breadcrumb mb-1">
                    ...
                    <li>Website</li>
                    <li><a class="text-muted" href="{{ route('website.orderby-picture.index') }}">Corporate Order</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="btn-group pull-right">
                                <button class="btn btn-sm btn-primary" onclick="location.href='{{ route('website.orderby-picture.index') }}'"> <i class="fa fa-save"></i> Back </button>
                                <a href="{{ route('website.orderby-picture.index') }}" class="btn btn-sm btn-secondary"> <i class="fa fa-list"></i> List </a>
                            </div>
