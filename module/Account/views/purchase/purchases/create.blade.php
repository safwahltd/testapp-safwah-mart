                                        ...
                                        <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-12 prod-price">
                                                                <select required name="product_id[]" onchange="enableQty('unit', 'purchasePrice-input', 'quantity-enable', this)" class="input-qty chosen-select-100-percent" data-placeholder="- Select Product -">
                                                                    <option></option>
                                                                    @foreach($products as $prod)
                                                                        <option value="{{ $prod->id }}" data-unit="{{ optional($prod->unit)->name }}" data-price="{{ $prod->purchase_price }}" {{ old('product_id')[$key] == $prod->id ? 'selected' : '' }}>{{ $prod->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </td>
                                            ...
                                            @else
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="purchase_price[]" type="text" value="" class="form-control only-number text-right purchasePrice-input" />
                                                        @error('purchase_price')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                        @enderror
                                                    </td>
