                    ...
                    <div class="col-sm-12 px-4">
                        <table class="table table-bordered table-striped" style="margin-bottom: 0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th class="text-center" colspan="2">Total In Page</th>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th class="text-right pr-1">{{ number_format($total_purchase_cr, 2) }}</th>
                                    <th class="text-right pr-1">{{ number_format($grand_total_amount, 2) }}</th>
                                    {{-- <th class="text-right pr-1">{{ number_format($total_balance, 2) }}</th> --}}
                                </tr>
                            </tfoot>
