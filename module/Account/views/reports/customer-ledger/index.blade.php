                    ...
                    <form action="" method="get">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control chosen-select-100-percent" name="company_id" data-placeholder="-Select Company-">
                                    ...
                                    @foreach ($companies as $id => $name)
                                        <option value="{{ $id }}" {{ request('company_id') == $id ? 'selected' : '' }} selected>{{ $name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="input-daterange input-group">
                                ...
                                {{-- <input type="text" class="form-control date-picker" name="to" value="{{ request('to') ?? date('Y-m-d') }}" placeholder="To" style="cursor: pointer"> --}}
