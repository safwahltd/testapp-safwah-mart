...
@section('content')
    <main class="app-content">
        ...
        <div class="row" style="display: inline;">
            <div class="col-md-12 text-center">
                <h3 style="color: #7592a5; margin-top: -10px !important;"><strong>Receive Voucher</strong></h3>
            </div>
        </div>
                    ...
                    <div class="row mt-5 mb-5">
                        <div class="hidden-print" style="float: right; padding-right: 10px !important;">
                            <div class="btn-group btn-group-xs">
                                ...
                                <a class="btn btn-danger btn-xs" href="{{ route('voucher-receives.index') }}"><i class=" fa fa-backward"></i> Back To List</a>
                            </div>
                        </div>
                    </div>
