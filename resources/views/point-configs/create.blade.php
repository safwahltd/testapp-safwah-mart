...
@section('title', 'Create Point Config')
...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form class="form-horizontal mt-2" action="{{ route('point-configs.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <div class="form-group mb-1">
                            <div class="input-group width-100">
                                ...
                                <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Title" autocomplete="off">
                            </div>
                        ...
                        <div class="form-group mb-1">
                            <div class="input-group width-100">
                                ...
                                <input type="text" class="form-control" name="min_purchase_amount" value="{{ old('min_purchase_amount') }}" placeholder="Min Purchase Amount" autocomplete="off" required>
                            </div>
                        ...
                        <div class="form-group mb-1">
                            <div class="input-group width-100">
                                ...
                                <input type="text" class="form-control" name="max_purchase_amount" value="{{ old('max_purchase_amount') }}" placeholder="Max Purchase Amount" autocomplete="off" required>
                            </div>
                        ...
                        <div class="form-group mb-1">
                            <div class="input-group width-100">
                                ...
                                <input type="text" class="form-control" name="point" value="{{ old('point') }}" placeholder="Point" autocomplete="off" required>
                            </div>
                        ...
                        <div class="btn-group pull-right">
                            <button class="btn btn-sm btn-theme"> <i class="far fa-check-circle"></i> SUBMIT </button>
